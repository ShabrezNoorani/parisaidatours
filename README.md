...
**Prompt 17** — Replaced Calendly embed on tour pages with right-side enquiry drawer (same slide-in animation as Bokun). Drawer shows tour summary, urgency nudge, and three contact options: Calendly link, WhatsApp with pre-filled message, and Email. Removed broken Calendly inline embed from mobile tour pages.
